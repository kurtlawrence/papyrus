...
#[cfg(windows)]
fn get_gags() -> io::Result<(gag::windows::Gag<io::Stdout>, gag::windows::Gag<io::Stderr>)> {
    Ok((gag::windows::stdout()?, gag::windows::stderr()?))
}

/// Returns (stdout, stderr).
#[cfg(unix)]
fn get_gags() -> io::Result<(gag::BufferRedirect, gag::BufferRedirect)> {
    Ok((
        gag::BufferRedirect::stdout()?,
        gag::BufferRedirect::stderr()?,
    ))
}
