...
mod macros {
	...
	macro_rules! repl {
		...
		(&mut $type:ty) => {{
			use papyrus;
			let mut r: papyrus::repl::Repl<_, _, $type, papyrus::prelude::linking::BrwMut> =
		...
		(&$type:ty) => {{
			use papyrus;
			let mut r: papyrus::repl::Repl<_, _, $type, papyrus::prelude::linking::Brw> =
				papyrus::repl::Repl::default();
		...
		($type:ty) => {{
			use papyrus;
			let mut r: papyrus::repl::Repl<_, _, $type, papyrus::prelude::linking::NoRef> =
				papyrus::repl::Repl::default();
		...
		() => {{
			use papyrus;
			let r: papyrus::repl::Repl<_, _, (), papyrus::prelude::linking::NoRef> =
				papyrus::repl::Repl::default();
				r
			}};
	}
